...
void CloudShader::initialize() 
{
	...
	attachShader("./cloudScene/shaderSource/cloudVertexShader.glsl", GL_VERTEX_SHADER);
	attachShader("./cloudScene/shaderSource/cloudFragmentShader.glsl", GL_FRAGMENT_SHADER);
